...
//
//        for (Map.Entry<Integer, Map<String, Object>> entry : product.entrySet()) {
//
//            Map<String, Object> details = entry.getValue();
//            int categoryId = (int) details.get("category_id");
//            String categoryName = category.get(categoryId);
//
//            System.out.println("Product: " + details.get("name") + ", Category: " + categoryName);
//        }
//    }
//}
